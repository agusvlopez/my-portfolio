...
<template>
    <section>
        <div class="md:h-screen mt-[100px] lg:mt-0 flex items-center justify-center flex-col pt-8 max-w-3xl mx-auto">
            ...
            <div class="flex space-x-8 text-xl font-bold">
                ...
                <a href="https://github.com/agusvlopez" target="_blank" class="textBlue relative group">
                    Github
                    <span
                        class="iconArrowRight inline-block align-middle opacity-0 group-hover:opacity-100 textBlue transition-opacity duration-300"></span>
                    <span
                ...
                <a href="https://www.figma.com/@agustinalopez" target="_blank" class="textBlue relative group">
                    Figma
                    <span
                        class="iconArrowRight inline-block align-middle opacity-0 group-hover:opacity-100 textBlue transition-opacity duration-300"></span>
                    <span
